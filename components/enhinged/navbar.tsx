      ...
      >
        <nav className="flex items-center justify-between px-6 py-4 md:px-12 md:py-5">
          ...
          >
            ...
            <span className="font-mono text-xs tracking-widest text-muted-foreground uppercase">Enhinged</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <span className="font-mono text-[10px] tracking-wider text-muted-foreground uppercase">HF Space Live</span>
          </div>
