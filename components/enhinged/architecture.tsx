...
const blocks = [
  { id: "input", name: "Input Embedding", desc: "Token indices mapped to 384-dimensional dense vectors." },
  { id: "pos", name: "Position Embedding", desc: "Absolute positional encodings added for sequence context." },
  { id: "b1", name: "Transformer Block 1", desc: "Multi-Head Attention (6 heads) + Feed Forward." },
  ...
  { id: "b6", name: "Transformer Block 6", desc: "Final contextual representations." },
  { id: "norm", name: "Layer Norm", desc: "Final normalization before projection." },
  { id: "head", name: "Language Modeling Head", desc: "Projects 384D vectors back to 50,257 vocab logits. (Tied weights)" },
]
    ...
    <section id="architecture" ref={containerRef} className="relative min-h-screen py-32 overflow-hidden bg-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center mb-24">
          ...
          >
            Hover over the pipeline to inspect the flow of data through the 30M parameter causal language model.
          </motion.p>
        </div>
