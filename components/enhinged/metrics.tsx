    ...
    <section id="metrics" className="relative py-24 md:py-32 bg-background border-t border-border overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8">
          {[
            { label: "Total Parameters", value: 30.04, decimals: 2, suffix: "M", delay: 0.1 },
            { label: "Best Val Loss", value: 1.4363, decimals: 4, delay: 0.2 },
            { label: "Perplexity", value: 4.2, decimals: 1, delay: 0.3 },
            { label: "Training Iters", value: 5000, decimals: 0, delay: 0.4 },
            { label: "Context Window", value: 256, decimals: 0, delay: 0.5 },
            { label: "Batch Size", value: 32, decimals: 0, delay: 0.6 },
            { label: "Vocab Size", value: 50257, decimals: 0, delay: 0.7 },
            { label: "Tokens/Sec Gen", value: 120, decimals: 0, suffix: "+", delay: 0.8 },
          ].map((metric, i) => (
            <motion.div
              key={metric.label}
