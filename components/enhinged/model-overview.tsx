          ...
          >
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-light tracking-tight text-balance">
                Built from <span className="italic text-primary">Scratch</span>
              </h2>
            </div>
            
            <p className="text-muted-foreground text-lg leading-relaxed">
              Enhinged is not a fine-tune. It's a custom PyTorch model trained from the ground up on a curated dataset of everyday Hinglish conversations.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Custom 1M token Hinglish corpus, memory-mapped for streaming.</p>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Optimizer state, weights, and configuration saved for resumability.</p>
              </div>
              <div className="space-y-2">
                <Cpu className="w-5 h-5 text-primary/70" />
                <h4 className="font-medium">Inference</h4>
                <p className="text-sm text-muted-foreground">KV-caching ready, top-p/top-k sampling, repetition penalties.</p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative glass-shell rounded-3xl p-8 border border-white/10 bg-black/40 backdrop-blur-xl">
              ...
              <div className="space-y-4 font-mono text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-primary-foreground">256</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-primary-foreground">384</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-white/50">dropout</span>
                  <span className="text-primary-foreground">0.2</span>
                </div>
