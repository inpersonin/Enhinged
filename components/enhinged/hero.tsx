    ...
    <section id="home" ref={containerRef} className="relative h-screen w-full overflow-hidden bg-background">
      ...
      <motion.div style={{ opacity, scale, y }} className="relative z-10 h-full flex flex-col justify-center items-center text-center p-6 md:p-12 pt-20">
        ...
        >
          ...
          <span className="font-mono text-[10px] tracking-widest text-white/70 uppercase">v1.0 Live on HF Space</span>
        </motion.div>
        ...
        >
          A completely bespoke GPT-2 architecture trained from scratch on everyday conversational Hinglish. Fast, compact, and unapologetically raw.
        </motion.p>
        ...
        >
          {[
            { label: "Parameters", value: "30.04M" },
            { label: "Layers", value: "6" },
            { label: "Context", value: "256" },
            { label: "Perplexity", value: "4.2" }
          ].map((stat) => (
